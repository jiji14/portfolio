...
function Resume() {
  ...
  const education = [
    {
      course: "M.S in Computer Science, San Francisco State University",
      term: "August 2022 ~ Present",
    },
    {
      course: "KG ITBANK 자바기반 웹개발자 과정",
      term: "March 2019 ~ August 2019",
    },
    { course: "서울여자대학교 의류학과", term: "March 2010 ~ August 2015" },
  ];
  const work = [
    {
      course: "Software Engineer Intern, NREL",
      detail: [],
      term: "September 2023 ~ Present",
    },
    {
      course: "Front-end Engineer Intern, Cadid",
      detail: [],
      term: "June 2023 ~ August 2023",
    },
    {
      course: "Web Accessibility Evaluator, SF State",
      detail: [],
    ...
    },
    {
      course: "놀이의발견 플랫폼실",
      detail: [],
      term: "September 2021 ~ July 2022",
    },
    {
      course: "Freelance Software Engineer, Daily Field",
      detail: [],
      term: "December 2020 ~ June 2021",
    },
    {
      course: "디에스랩 글로벌 개발팀",
      detail: [],
      term: "August 2019 ~ April 2021",
    },
  ];
  const skills = [
    { name: "HTML", src: html },
    ...
    { name: "React /React Native", src: react },
    { name: "Next.js", src: nextjs },
    { name: "Redux/Saga", src: redux },
    { name: "Firebase", src: firebase },
    { name: "Jest", src: jest },
    { name: "Cypress", src: cypress, isBig: true },
    { name: "Git", src: git },
  ];
            ...
            return (
              <div className="skillsContainer">
                <img
                  alt={`skill${i}`}
                  src={skill.src}
                  className={`stack ${skill.isBig && "bigLogo"}`}
                  key={skill + i}
                />
